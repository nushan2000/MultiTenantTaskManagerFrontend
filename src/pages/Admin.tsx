...
import LightMinimalTheme from "../themes/LightMinimalTheme";
import ModernGlassTheme from "../themes/ModernGlassTheme";

// Map tenants to their specific admin components
const tenantAdminComponents: Record<string, React.FC> = {
  
  "2": ModernGlassTheme,
  "1":DarkProfessionalTheme,
  "3":LightMinimalTheme,
  "4":ModernGlassTheme
};
...
export const Admin = () => {
  ...
  // Get the specific admin component for this tenant, or fall back to default
  const AdminComponent = tenantAdminComponents[tenantId] || LightMinimalTheme;
